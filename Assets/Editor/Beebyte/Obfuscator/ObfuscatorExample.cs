using Plugins.Beebyte.Obfuscator;
using UnityEngine;
...
namespace Editor.Beebyte.Obfuscator
{
    public class ObfuscatorExample : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("OldPublicField"),Rename("RenamedPublicField")]
        ...
        private void Start() // <- Key MonoBehaviour methods like Start are left untouched
        {
