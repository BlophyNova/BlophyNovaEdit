        ...
        public RippleController Init(float currentScaleX, float currentScaleY)
        {
            ...
            texture[0].transform.localScale = //第12根线都是水平的
                texture[1].transform.localScale =
                    new Vector2(2 - ValueManager.Instance.boxFineness / currentScaleX,
                        ValueManager.Instance.boxFineness / currentScaleY);

            texture[2].transform.localScale = //第34都是垂直的
                texture[3].transform.localScale =
                    new Vector2(2 + ValueManager.Instance.boxFineness / currentScaleY,
                        ValueManager.Instance.boxFineness / currentScaleX);
            return this;
        }
    }
}