...
{
    public class ChartWriter : ContentEdit
    {
        ...
        void Start()
        {
            ...
            {
                GlobalData.Instance.metaData.chartWriter = thisTMPInputField.text;
        ...
        {
            thisTMPInputField.SetTextWithoutNotify(GlobalData.Instance.metaData.chartWriter);
        }
    }
}
