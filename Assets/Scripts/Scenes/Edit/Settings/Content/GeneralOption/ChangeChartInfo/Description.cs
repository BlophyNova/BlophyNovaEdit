...
{
    public class Description : ContentEdit
    {
        ...
        void Start()
        {
            ...
            {
                GlobalData.Instance.metaData.description = thisTMPInputField.text;
        ...
        {
            thisTMPInputField.SetTextWithoutNotify(GlobalData.Instance.metaData.description);
        }
    }
}
