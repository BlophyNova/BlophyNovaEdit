...
{
    public class MusicName : ContentEdit
    {
        ...
        void Start()
        {
            ...
            {
                GlobalData.Instance.metaData.musicName = thisTMPInputField.text;
        ...
        {
            thisTMPInputField.SetTextWithoutNotify(GlobalData.Instance.metaData.musicName);
        }
    }
}
