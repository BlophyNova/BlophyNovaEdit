...
{
    public class ChartLevel : ContentEdit
    {
        ...
        void Start()
        {
            ...
            {
                GlobalData.Instance.metaData.chartLevel = thisTMPInputField.text;
        ...
        {
            thisTMPInputField.SetTextWithoutNotify(GlobalData.Instance.metaData.chartLevel);
        }
    }
}
