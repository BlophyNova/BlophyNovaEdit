...
{
    public class ArtWriter : ContentEdit
    {
        ...
        void Start()
        {
            ...
            {
                GlobalData.Instance.metaData.artWriter = thisTMPInputField.text;
        ...
        {
            thisTMPInputField.SetTextWithoutNotify(GlobalData.Instance.metaData.artWriter);
        }
    }
}
