...
namespace Manager
{
    public class ValueManager : MonoBehaviourSingleton<ValueManager>//这里存放一些数值相关的东西
    {
        ...
        [FormerlySerializedAs("FPS"),Tooltip("Runtime目标FPS")] public int fps;
        ...
        [FormerlySerializedAs("fullFlick_noteRightJudgeRange"),Tooltip("大滑键音符左边的空间判定范围，世界坐标为主")] public float fullFlickNoteRightJudgeRange;
        [FormerlySerializedAs("fullFlick_noteLeftJudgeRange"),Tooltip("大滑键音符左边的空间判定范围，世界坐标为主")] public float fullFlickNoteLeftJudgeRange;
        ...
        [FormerlySerializedAs("holdHitEffectCDTime"),Tooltip("Hold音符的特效播放间隔多长时间")] public float holdHitEffectCdTime;//就是Hold打击特效播放完一次后CD是多少，播放完一次后多少秒内不能继续播放
