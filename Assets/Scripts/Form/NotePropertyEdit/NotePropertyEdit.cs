...
public class NotePropertyEdit : LabelWindowContent
{
    ...
    {
        if (labelWindow.associateLabelWindow.currentLabelWindow.labelWindowContentType == LabelWindowContentType.NoteEdit)
        {
            RefreshNotes();
        }
        if (labelWindow.associateLabelWindow.currentLabelWindow.labelWindowContentType == LabelWindowContentType.EventEdit)
        {
            RefreshEvents();
        }
    ...
    {
        NoteEdit noteEdit = (NoteEdit)labelWindow.associateLabelWindow.currentLabelWindow;

        ChartTool.ConvertEditLine2ChartDataLine(GlobalData.Instance.chartEditData.boxes[noteEdit.currentBoxID], GlobalData.Instance.chartData.boxes[noteEdit.currentBoxID], noteEdit.currentLineID);
    ...
    public void RefreshEvents()
    {
        ...
        {
            Data.Enumerate.EventType.ScaleX => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.scaleX,
            Data.Enumerate.EventType.ScaleY => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.scaleY,
            Data.Enumerate.EventType.MoveX => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.moveX,
            Data.Enumerate.EventType.MoveY => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.moveY,
            Data.Enumerate.EventType.CenterX => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.centerX,
            Data.Enumerate.EventType.CenterY => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.centerY,
            Data.Enumerate.EventType.Alpha => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.alpha,
            Data.Enumerate.EventType.LineAlpha => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.lineAlpha,
            Data.Enumerate.EventType.Rotate => GlobalData.Instance.chartEditData.boxes[eventEdit.currentBoxID].boxEvents.rotate,
        ...
        {
            Data.Enumerate.EventType.ScaleX => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.scaleX,
            Data.Enumerate.EventType.ScaleY => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.scaleY,
            Data.Enumerate.EventType.MoveX => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.moveX,
            Data.Enumerate.EventType.MoveY => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.moveY,
            Data.Enumerate.EventType.CenterX => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.centerX,
            Data.Enumerate.EventType.CenterY => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.centerY,
            Data.Enumerate.EventType.Alpha => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.alpha,
            Data.Enumerate.EventType.LineAlpha => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.lineAlpha,
            Data.Enumerate.EventType.Rotate => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].boxEvents.rotate,
            _ => GlobalData.Instance.chartData.boxes[eventEdit.currentBoxID].lines[0].speed,
        };
        if (@event.eventType != Data.Enumerate.EventType.Speed) ChartTool.ForeachBoxEvents(editBoxEvent, chartDataBoxEvent);
        else
        {
    ...
    void EventStartBeatsChanged(string value)
    {
        ...
        if (match.Success)
        {
            BPM startBeats = new(int.Parse(match.Groups[1].Value), int.Parse(match.Groups[2].Value), int.Parse(match.Groups[3].Value));
    ...
    public void SelectedNote(EventEditItem @event)
    {
        ...
        startTime.SetTextWithoutNotify($"{this.@event.@event.startBeats.integer}:{this.@event.@event.startBeats.molecule}/{this.@event.@event.startBeats.denominator}");
        endTime.SetTextWithoutNotify($"{this.@event.@event.endBeats.integer}:{this.@event.@event.endBeats.molecule}/{this.@event.@event.endBeats.denominator}");
